...
class RateApiHandleTest {

    @InjectMocks
    RateApiHandle rateApi;
    ...
    public void testFindById_ExistingOrderDetail() {
        ...
        OrderDetails mockOrderDetail = new OrderDetails();
...
// Mock the behavior of orderDetailRepository.findById(orderDetailId)
        ...
        // Call the method under test
        ResponseEntity<Rate> result = rateApi.findByOrderDetailId(orderDetailId);
    ...
    public void testFindByProduct_ExistingProduct() {
        ...
        // Call the method under test
        ResponseEntity<List<Rate>> result = rateApi.findByProductId(productId);
