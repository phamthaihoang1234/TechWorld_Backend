...
class UserApiHandleTest {

    @InjectMocks
    UserApiHandle userApi;
    ...
    void GivenValidLoginRequest_authenticateUser_ReturnJwtResponse() {
        ...
        assertEquals(HttpStatus.OK, result.getStatusCode()); // Kiểm tra status code là OK
        assertTrue(result.getBody() instanceof JwtResponese); // Kiểm tra body là instance của JwtResponse

        JwtResponese jwtResponse = (JwtResponese) result.getBody();
    ...
    void GivenValidSignupRequest_registerUser_ReturnSuccessMessageResponse() {
        ...
        assertEquals(signupRequest.getName(), savedUser.getUsername());
        assertEquals(signupRequest.getEmail(), savedUser.getEmail());
        assertEquals(hashedPassword, savedUser.getPassword());
        assertEquals(signupRequest.getPhone(), savedUser.getPhoneNumber());
    ...
    void logout_ReturnOkResponse() {
        ...
        CartDetailApiHandle cartDetailApi = new CartDetailApiHandle();
    ...
    void GivenExistingEmail_sendToken_ReturnOkResponse() {
        ...
        CartDetailApiHandle cartDetailApi = mock(CartDetailApiHandle.class);
