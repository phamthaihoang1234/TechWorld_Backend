...
import com.example.TechWorld.dto.request.OrderRequest;
...
class OrderApiHandleTest {

    @InjectMocks
    OrderApiHandle orderApi;
    ...
    void GivenValidEmailAndCart_checkout_ReturnOrder() {
        ...
        items.add(new CartDetail(1L, 1, 10.0, cart, new Product()));
        items.add(new CartDetail(2L, 2, 20.0, cart, new Product()));
    ...
    void GivenValidEmailAndOrderRequest_checkout_ReturnOrder() {
        ...
        cartDetails.add(new CartDetail(1L, 2, 10.0, cart, new Product()));
