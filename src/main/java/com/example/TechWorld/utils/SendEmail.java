...
public class SendEmail {
    ...
    /*public void sendMailOrder(Order order) {
        ...
        sendMailSer.queue(order.getUser().getEmail(), "Đặt hàng thành công", content.toString());
    }
    ...
    public void sendMailOrderSuccess(Order order) {
        ...
        content.append(
                "<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
                        ...
                        + "</p>\r\n" + "                                                        </td>");
        content.append(FOOTER);
        sendMailSer.queue(order.getUser().getEmail(), "Thanh toán thành công", content.toString());
    }
    ...
    public void sendMailOrderDeliver(Order order) {
        ...
        content.append(
                "<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
                        ...
                        + "</p>\r\n" + "                                                        </td>");
        content.append(FOOTER);
        sendMailSer.queue(order.getUser().getEmail(), "Đơn hàng đã được xác nhận", content.toString());
    }
